...
void Betngan::Application::configureOpenGL() {
...
Betngan::WindowConfiguration Betngan::Application::getWindowConfiguration() {
...
void Betngan::Application::setupCallbacks() {
